...
def populate():
	...
	# Then we will create a dictionary of dictionaries for our categories. This might seem a little confusing but it allows us to iterate through each data structure, and add data to our models.
